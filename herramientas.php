...
<!-- Logos herramientas  Container 
	...
	<h2 class="orange">Nuestras herramientas</h2>
	<h4 class="display">Nos empoderan.</h4><img src="logos/GNUlinux.svg.png" alt="GNU/Linux" class="tux">
	...
	<ul class="weapons-logos">
	  ...
	  <li>
	    <a href="http://wordpress.org/" target="_blank"><img class="display" src="logos/wordpress.svg" alt="Wordpress" title="Wordpress" bord\
								 er="0"></a>
	  </li>
