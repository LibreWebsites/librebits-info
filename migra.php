  ...
  <body>
    ...
    <div class="container marketing">
	  ...
	  <span style="font-size:2.5em;" class="glyphicon glyphicon-plane"></span>
          ...
          <h2>Agilidad,Potencia & Resiliencia</h2>
	  ...
	  <p>Migra a entornos TIC (más) potentes, ágiles y resilientes.</p>
...
<!--              <p><a class="btn btn-lg btn-primary" href="#" role="button">Saber más >>></a></p> -->
      ...
      <hr class="featurette-divider">
            ...
            <div class="row featurette">
        <div class="col-md-7 col-md-push-5">
          <h2 class="featurette-heading">¿llegó la hora de actualizar/migrar </<span class="text-muted"> tus sistemas/servidores/PCs ?, hazlo con todas las garantías.</span></h2><p class="lead"> Con una visión de conjunto, tus herramientas  diseminadas en varios dispositivos, son capaces de orquestarse con más armonía y estabilidad. Migra/actualiza/libera tus sistemas al software más potente actualmente.Libre. Sencillamente.</p>
	   <p><i>Sin ataduras »</i>  <a href="libera-tu-pc.php">Empodera tus PCs / Servidores y multiplica sus posibilidades.</a> Que trabajen por tí. No al revés.</p>					   
        </div>
        <div class="col-md-5 col-md-pull-7">
