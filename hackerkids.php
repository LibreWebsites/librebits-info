...
<!-- Logos herramientas  Container 
	...
	<h4 class="display"> Experimentación autónoma y la resolución creativa de problemas. <br> Estableciendo  una relación sana con las nuevas tecnologías <br> desde el juego no directivo.</h4>
	...
	<h5 class="display">...en (permanente) construcción ;-) </h4>
